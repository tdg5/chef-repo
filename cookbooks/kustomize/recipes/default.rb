...
download_url = node['kustomize']['download_url'] ||
               format(node['kustomize']['download_url_template'], architecture: node['kustomize']['architecture'], operating_system: node['kustomize']['operating_system'], version: version)
